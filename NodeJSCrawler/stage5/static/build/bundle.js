...
var _serverSocket = __webpack_require__(29);

var _serverSocket2 = _interopRequireDefault(_serverSocket);
...
function formSubmitHandler(formData) {
	...
	_serverSocket2.default.emitSpiderRequest(formData, function (res) {
		console.log(res);
	});
...
function initEventLis() {
	...
	_serverSocket2.default.addServerUpdateEventHandler(null, function (data) {
		renderResult(data);
	});
}
...
var ServerSocket = {
	emitSpiderRequest: function emitSpiderRequest(data, cb) {
		socket.emit('spider', data, cb);
	},
	addServerUpdateEventHandler: function addServerUpdateEventHandler(context, fn) {
